...
export const memberFormSchema = z.object({
  ...
  linkedin: z.url({ message: "Invalid URL" }).or(z.string().min(0)).optional(),
  instagram: z.url({ message: "Invalid URL" }).or(z.string().min(0)).optional(),
  github: z.url({ message: "Invalid URL" }).or(z.string().min(0)).optional(),
  core: z.boolean(),
