...
const Highlights = () => {
  return (
    <div className="w-full h-full flex md:flex-row flex-col gap-10 md:px-14 px-10 py-10 max-w-2xl lg:max-w-7xl mx-auto">
      <div className="w-full h-full flex -space-x-[12%] justify-center">
        <div className="size-1/3 bg-accent rounded-xl shadow-lg -rotate-30 aspect-square">
          <img
        ...
        <div className="size-1/3 bg-accent rounded-xl shadow-lg -rotate-20 aspect-square">
          <img
        ...
        <div className="size-1/3 bg-accent rounded-xl shadow-lg -rotate-10 aspect-square">
          <img
        ...
        <div className="size-1/3 bg-accent rounded-xl shadow-lg rotate-0 aspect-square">
          <img
